...
export default function Layout({ children, activePage, onNavigate, onToast }) {
  ...
  const erpItems = [
    { id: 'erp-kpi',       label: 'KPI Dashboard',   icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg> },
  ...
  const pageTitles = {
    ...
    'erp-kpi': 'KPI Dashboard', timesheet: 'Timesheet', approvals: 'Approvals', 'erp-team': 'Team Dashboard', pnl: 'Profit & Loss', 'erp-reports': 'Reports', 'erp-resources': 'Resources',
  };
